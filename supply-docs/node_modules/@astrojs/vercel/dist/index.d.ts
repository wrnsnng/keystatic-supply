...
export default function vercelAdapter({ webAnalytics, includeFiles: _includeFiles, excludeFiles: _excludeFiles, imageService, imagesConfig, devImageService, edgeMiddleware, maxDuration, isr, skewProtection, }?: VercelServerlessConfig): AstroIntegration;
export {};
